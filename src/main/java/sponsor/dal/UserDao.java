...
public class UserDao {
    ...
    public Users create(Users user) throws SQLException {
        String insertUser = "INSERT INTO Users(USERNAME, EMAIL, PASSWORD_HASH, CREATED_AT) VALUES(?, ?, ?, ?);";
    ...
    public Users getUserByUserId(int userId) throws SQLException {
        String selectUser = "SELECT USER_ID, USERNAME, EMAIL, PASSWORD_HASH, CREATED_AT FROM Users WHERE USER_ID=?;";
        Connection connection = null;
        ...
        try {
            ...
            if (results.next()) {
                ...
                Date createdAt = new Date(results.getTimestamp("CREATED_AT").getTime());
    ...
    public Users updateEmail(Users user, String newEmail) throws SQLException {
        String updateUser = "UPDATE Users SET EMAIL=? WHERE USER_ID=?;";
        Connection connection = null;
    ...
    public Users delete(Users user) throws SQLException {
        ...
        try {
            ...
            if (affectedRows == 0) {
                throw new SQLException("No records available to delete for USER_ID=" + user.getUserId());
            }
            return null;
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public List<Users> getUsersByUsername(String username) throws SQLException {
        ...
        String selectUsers = "SELECT USER_ID, USERNAME, EMAIL, PASSWORD_HASH, CREATED_AT FROM Users WHERE USERNAME=?;";
        Connection connection = null;
        PreparedStatement selectStmt = null;
        ResultSet results = null;
        try {
